...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <div class="section parallax mb-0 mt-0 d-flex align-items-center proximos-desafios portada">
            <div class="container clearfix">
                <div class="arr-izk">
                    <img src="vid/mundito.gif" height="380px">
                </div>
                <div>
                    <h2 class="titulo-seccion" style="color: #fff;">Próximos desafíos</h2>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="card border-color-info p-2 py-lg-5 px-xl-3 px-lg-2">
                                                <div class="card-body rounded">
                                                    <div class="feature-box media-box">
                                                        ...
                                                        <div class="fbox-content">
                                                            <h3 class="font-weight-normal ls0 nott">Economías Regionales</h3>
                                                            <p >Comenzar a sentar las bases del “Comercio Justo”, generando una mayor transparencia comercial y garantizando la disponibilidad de mano de obra mediante la compatibilización de Planes Sociales y Trabajo Registrado.
                                                    ...
                                                    <div class="feature-box media-box">
                                                        ...
                                                        <div class="fbox-content">
                                                            ...
                                                            <p >Implementar progresivamente la modalidad blended ó mixta (cursos con una parte presencial y otra virtual) para la oferta de actividades de capacitación
                                                                ...
                                                                <p>Desarrollar programas de formación en articulación con el sector público para impulsar la empleabilidad. </p>
                                            ...
                                            <div class="card border-color-yellow p-2 py-lg-5 px-xl-3 px-lg-2 mt-3 mt-lg-5">
                                                <div class="card-body rounded">
                                                    <div class="feature-box media-box">
                                                        ...
                                                        <div class="fbox-content">
                                                            <h3 class="font-weight-normal nott ls0">Mujeres Empresarias</h3>
                                                            <p >Fomentar el desarrollo de proyectos de mujeres en naves industriales, generando cadenas de valor con los productos primarios de cada región.
                                                            </p>
                                                           <p>Impulsar proyectos de mujeres rurales y huertas orgánicas, para dotar de conocimientos, habilidades y herramientas a las mujeres que habitan los parajes y cinturones de poblaciones, y que son sostén familiar. 
